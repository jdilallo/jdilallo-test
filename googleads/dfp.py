...
_SERVICE_MAP = {
    'v201311':
        ('ActivityGroupService', 'ActivityService', 'AdRuleService',
         ...
         'LineItemTemplateService', 'NetworkService', 'OrderService',
         'PlacementService', 'ProductService', 'ProductTemplateService',
         ...
         'ReconciliationReportRowService', 'ReconciliationReportService',
         'ReportService', 'SuggestedAdUnitService', 'TeamService',
...
class DataDownloader(object):
  ...
  def DownloadPqlResultSetToCsv(self, pql_query, file_handle, values=None):
